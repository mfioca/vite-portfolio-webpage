...
function whiterunConstructionLink(folder: string, asset: string, width: number) {
  const baseURL = window.location.hostname === "localhost"
    ? "http://localhost:3000/vite-portfolio-webpage"
    : `${import.meta.env.BASE_URL}`;

  return `${baseURL}/whiterun_building_city/${folder}/${asset}?w=${width}&q=75`;
}
...
export const building_enterance = [
  ...
  ({ asset, alt, width, height }) =>
    ({
      src: `${whiterunConstructionLink("enterance", asset, width)}&t=${Date.now()}`,
      alt,
      width,
      height,
...
export const building_section_1 = [
  ...
  ({ asset, alt, width, height }) =>
    ({
      src: `${whiterunConstructionLink("section_1", asset, width)}&t=${Date.now()}`,
      alt,
      width,
      height,
      srcSet: undefined, // Disable srcSet
...
export const building_section_2 = [
  ...
  ({ asset, alt, width, height }) =>
    ({
      src: `${whiterunConstructionLink("section_2", asset, width)}&t=${Date.now()}`,
      alt,
      width,
      height,
      srcSet: undefined, // Disable srcSet
...
export const building_keep = [
  ...
  ({ asset, alt, width, height }) =>
    ({
      src: `${whiterunConstructionLink("keep", asset, width)}&t=${Date.now()}`,
      alt,
      width,
      height,
      srcSet: undefined, // Disable srcSet
...
export const building_random_extras = [
  ...
  ({ asset, alt, width, height }) =>
    ({
      src: `${whiterunConstructionLink("random_extras", asset, width)}&t=${Date.now()}`,
      alt,
      width,
      height,
      srcSet: undefined, // Disable srcSet
